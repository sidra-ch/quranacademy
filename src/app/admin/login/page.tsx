      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            placeholder="••••••••"
            className="w-full rounded-xl border border-white/20 bg-white/10 px-4 py-2.5 pr-11 text-sm text-white placeholder:text-white/40 outline-none focus:border-[#D4AF37]/60"
          />
          <button
            type="button"
